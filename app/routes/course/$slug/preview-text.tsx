...
import PreviewModalText from '~/components/PreviewModalText';
...
function PreviewTextCourse() {
  const { getLesson, slug } = useLoaderData() as { getLesson: CourseLessons; slug: string };
  return <PreviewModalText text={getLesson.textContent} title={getLesson.lessonTitle} slug={slug} isBuilder={false} />;
}

export default PreviewTextCourse;
